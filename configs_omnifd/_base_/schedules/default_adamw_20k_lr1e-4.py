...
param_scheduler = [
    ...
    dict(type='CosineAnnealingLR', T_max=17500, eta_min=1e-6, by_epoch=False, begin=2000, end=20000),
]

# train, val, test setting
train_cfg = dict(by_epoch=False, max_iters=20000, val_interval=20000)
val_cfg = dict()
test_cfg = dict()
